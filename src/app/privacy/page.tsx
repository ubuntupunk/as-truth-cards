        ...
        <section className="container mx-auto max-w-4xl py-12 space-y-16">
          ...
          <section className="bg-card rounded-lg p-6 shadow-sm">
            <p className="mb-4">
              ...
              information when you visit, interact with or make a purchase from Truth Cards (the
              “Site”).
            </p>
          </section>
          <section className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                Examples of Personal Information collected: version of web browser, IP address, time
                zone, cookie information, what sites or products you view, search terms, and how you
                interact with the Site.
              </li>
              <li>
                Purpose of collection: to load the Site accurately for you, and to perform analytics
          ...
          <section className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                We use Vercel to power our online store — you can read more about how Vercel uses
                your Personal Information here: [Link to Service Provider Privacy Policy].
              </li>
              <li>
          ...
          <section className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="mb-4">
              If you are a resident of the EEA, you have the right to access Personal Information we
              hold about you, to port it to a new service, and to ask that your Personal Information
              be corrected, updated, or erased. If you would like to exercise this right, please
            ...
            <p className="mb-4">
              ...
              information in order to fulfill contracts you might have with us (for example through
          ...
          <section className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="mb-4">
              ...
              would like to make a complaint, please contact us by e-mail at [email address] or by
