  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          Attempt to decompile or reverse engineer any software contained on Netbones's website;
        </li>
      ...
      <p className="mb-4">
        ...
        be terminated by at any time. Upon terminating your viewing of these materials or upon the
      ...
      <p className="mb-4">
        Further, Netbones does not warrant or make any representations concerning the accuracy,
      ...
      <p className="mb-4">
        ...
        entertainment purposes only. By using the Site, you acknowledge and agree that neither Truth
        Cards, nor Netbones are responsible for any emotional reactions, distress, or other
        consequences that may arise from viewing or interacting with the content. We encourage users
        to approach the content with discretion and to seek professional support if they experience
      ...
      <p className="mb-4">
        ...
        by Truth Card or Netbones of the site. Use of any such linked website is at the user's own
        risk.
      </p>
